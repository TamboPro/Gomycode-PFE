...
export default function Navbarhorizontal() {
  return (
    <div className="flex flex-row h-full">
      <nav className="bg-neutral-800 w-20 justify-between flex flex-col border border-neutral-900 border-r-gray-50 border-opacity-10">
      ...
      <div className="px-16 py-4 text-gray-700 bg-neutral-900 h-screen w-screen">
